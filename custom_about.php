					...
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
							<div class="about-text">
								...
								<p class="about-para">I'm an experienced full-stack developer specializing in PHP, SQL, MySQL, WordPress, Boostrap, RESPONSIVE HTML, web apps, Photoshop Design, Illustrator arts, javaScript, jQuery, HTML5 and CSS3. I have more than 6 years of experience in web development.</p>
